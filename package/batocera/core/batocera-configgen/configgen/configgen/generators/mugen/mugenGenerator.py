...
class MugenGenerator(Generator):
    ...
    # wine exits as soon as it has handed the game over to the wineserver, so the run
    # isn't over when the command returns: nothing may hold the rom once this exits
